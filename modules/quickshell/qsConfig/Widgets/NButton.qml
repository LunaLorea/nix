...
Rectangle {
  ...
  property color hoverColor: Colors.mTertiary
  ...
  color: {
    if (!enabled)
      return outlined ? Colors.transparent : Qt.lighter(Colors.mSurfaceVariant, 1.2)
    if (hovered)
      return hoverColor
    return outlined ? Colors.transparent : backgroundColor
  }
  ...
  border.color: {
    ...
    return outlined ? backgroundColor : Colors.transparent
  }
