...
RowLayout {
  ...
  Rectangle {
    ...
    border.color: (root.hovering || decreaseArea.containsMouse || increaseArea.containsMouse) ? Colors.mTertiary : Colors.mOutline
    border.width: 1
    ...
    Item {
      ...
      Item {
        ...
        Rectangle {
          ...
          radius: width / 2
          anchors.left: parent.left
          color: decreaseArea.containsMouse ? Colors.mTertiary : Colors.transparent
          Behavior on color {
            ColorAnimation {
              duration: Style.animationFast
            }
      ...
      NIcon {
        ...
        color: decreaseArea.containsMouse ? Colors.mOnTertiary : Colors.mPrimary
      }
    ...
    Item {
      ...
      Item {
        ...
        Rectangle {
          ...
          radius: width / 2
          anchors.right: parent.right
          color: increaseArea.containsMouse ? Colors.mTertiary : Colors.transparent
          Behavior on color {
            ColorAnimation {
              duration: Style.animationFast
            }
      ...
      NIcon {
        ...
        icon: "chevron-right"
        font.pointSize: Style.fontSizeS * scaling
        color: increaseArea.containsMouse ? Colors.mOnTertiary : Colors.mPrimary
      }
