...
Singleton {
  ...
  readonly property bool cachedWifiState: cacheAdapter.wifiState
  ...
  function setWifiEnabled(enabled) {
    cacheAdapter.wifiState = enabled
  ...
  Process {
    ...
    stdout: StdioCollector {
      onStreamFinished: {
        ...
        if (cacheAdapter.wifiState !== enabled) {
          cacheAdapter.wifiState = enabled
        }
      }
    }
  ...
  Process {
    ...
    running: false
    command: ["nmcli", "radio", "wifi", cacheAdapter.wifiState ? "on" : "off"]
